...
void prt_expression(A_NODE *node, int s)
{
    ...
    switch(node->name) { 
        ...
        case N_EXP_FUNCTION_CALL : 
            ...
            break; 
        case N_EXP_STRUCT : case N_EXP_ARROW :
            prt_expression(node->llink, s+1);
            prt_STRING(node->rlink, s+1);
            break; 
        case N_EXP_POST_INC : case N_EXP_POST_DEC : case N_EXP_PRE_INC : case N_EXP_PRE_DEC : case N_EXP_AMP : case N_EXP_STAR : 
        case N_EXP_NOT : case N_EXP_PLUS : case N_EXP_MINUS : case N_EXP_SIZE_EXP :
            prt_expression(node->clink, s+1); 
            break; 
        ...
        case N_EXP_CAST :
            ...
            prt_expression(node->rlink, s+1); 
            break; 
        case N_EXP_MUL : case N_EXP_DIV : case N_EXP_MOD : case N_EXP_ADD : case N_EXP_SUB : case N_EXP_LSS : case N_EXP_GTR : 
...
void prt_statement(A_NODE *node, int s)
{
    ...
    switch(node->name) { 
        ...
        case N_STMT_IF_ELSE:
            ...
            prt_statement(node->rlink, s+1);
            break; 
        case N_STMT_IF: case N_STMT_SWITCH:
            prt_expression(node->llink, s+1);
            prt_statement(node->rlink, s+1);
            break; 
        case N_STMT_WHILE:
