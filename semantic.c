...
A_TYPE *sem_expression(A_NODE *node)
{
    ...
    case N_EXP_POST_DEC:
        ...
        // usual binary expression between the expression and 1
...
//check argument-expression-list in function cell expression
...
// check type and return its size (size of imcomplete type is 0)
